...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Second_name.setGeometry(QRect(10, 130, 61, 21))
        ...
        self.Second_name_data = QLineEdit(self.centralwidget)
        self.Second_name_data.setObjectName(u"Second_name_data")
        self.Second_name_data.setGeometry(QRect(80, 130, 131, 20))
