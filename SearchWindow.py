...
class Ui_MainWindow(object):
    def setup(self, MainWindow):
        ...
        MainWindow.resize(222, 246)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.Surname = QLabel(self.centralwidget)
        self.Surname.setObjectName(u"Surname")
        self.Surname.setGeometry(QRect(10, 40, 61, 20))
        self.Secondname_search = QLineEdit(self.centralwidget)
        self.Secondname_search.setObjectName(u"Secondname_data")
        self.Secondname_search.setGeometry(QRect(80, 100, 131, 20))
        self.ID = QLabel(self.centralwidget)
        self.ID.setObjectName(u"ID")
        self.ID.setGeometry(QRect(10, 10, 61, 21))
